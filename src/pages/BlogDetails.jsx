      ...
      <Row>
        <Col lg='8' md='8'>
          <div className="blog__details">
            ...
            <span className='blog__auther'>
                    ...
                    <span className='section__description d-flex align-items-center gap-1'>
                        <i className='ri-calendar-line'></i>{blog.data}
                        </span>
                        <span className='section__description d-flex align-items-center gap-1'>
          ...
          <div className="comment__content">
              ...
              <p className="section__description">Lorem ipsum dolor sit amet consectetur adipisicing elit. Porro ad autem quos nemo expedita animi, earum velit fugit quisquam rerum!
              </p>

            <span className='erplay d-flex align-items-center gap-1'><i className='ri-reply-line'>Replay</i></span>
            </div>
          </div>
          {/*================= comment form ============*/}
